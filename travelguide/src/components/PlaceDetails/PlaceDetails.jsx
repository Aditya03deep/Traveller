        ...
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Typography gutterBottom variant="subtile1">out of {place.num_reviews}</Typography>
                </Box>
                <Box display="flex" justifyContent="space-between">
                    <Typography variant="subtile1">Price</Typography>
                    <Typography gutterBottom variant="subtile1">{place.price_level}</Typography>
                </Box>
                <Box display="flex" justifyContent="space-between">
                    <Typography variant="subtile1">Ranking</Typography>
                    <Typography gutterBottom variant="subtile1">{place.ranking}</Typography>
                </Box>
